...
const ExclusiveSection = () => {
  ...
  return (
    <div className="w-full flex justify-center min-h-screen bg-background py-0 lg:py-24 overflow-hidden border-b border-[#5BBA6F]">
      <div className="w-full max-w-5xl px-7 py-8 relative flex flex-col items-center">
        <div className="w-[98%] bg-primary absolute top-8 bottom-60 rounded-3xl max-h-[600px]"></div>
