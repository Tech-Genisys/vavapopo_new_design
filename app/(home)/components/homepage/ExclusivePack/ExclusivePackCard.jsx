  ...
  return (
    <div className="w-[600px] flex justify-center -ml-2">
      <div
        ...
        style={styling}
      >
        <div className="bg-white flex flex-col items-center justify-center gap-1 mb-6 px-6 py-4 sm:px-12 sm:py-7 rounded-3xl shadow min-w-[240px] sm:w-[300px] md:w-[400px] w-[200px]">
